...
def header_detail():
    ...
    # author = find_author(token_data.get('email'))
...
def edit_author_book():
    ...
    for book in author_books:
        if book.title == title:
            ...
            # return jsonify(isSuccessful='false', info='Book does not exist or unAuthorized', status_code=404), 404
...
def genre(genre):
    """" Returns books by with requested genre"""
    book_list = all_books()
    genre_list = []
